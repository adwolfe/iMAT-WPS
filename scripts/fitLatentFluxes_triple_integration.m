function [FluxDistribution, latentRxn,Nfit_latent, minTotal,MILPproblem_minFlux] = fitLatentFluxes_triple_integration(MILProblem, model, PFD, Hgenes, epsilon_f,epsilon_r,latentCAP,verbose,relMipGapTol)
...
minTotal = MILProblem.b(end) ./ (1+latentCAP); % 06272023: allow running on empty category data
solution = struct(); % 06272023: allow running on empty category data
solution.full = MILProblem.x0; % 06272023: allow running on empty category data
Nfit_latent = 0; % 06272023: allow running on empty category data
MILPproblem_minFlux = MILProblem; % 06272023: allow running on empty category data
...
while 1
    ...
    c_minFlux = MILProblem.minTotalObj;
