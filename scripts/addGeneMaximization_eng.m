function [MILPproblem] = addGeneMaximization_eng(MILPproblem, HGeneList, HRxnList,LRxnList, model,forceOpenGene)
...
newlbs = zeros(length(HGeneList),1);
newlbs(ismember(HGeneList, forceOpenGene)) = 1;
lb = [MILPproblem.lb;newlbs];
