function [epsilon_f, epsilon_r,capacity_f,capacity_r] = makeEpsilonSeq_server(model, reactions, epsilon0, k)
...
for i = 1: length(reactions)
    ...
    Vm_f = optimizeCbModel_XL(testModel, 'max');
    ...
    Vm_r = optimizeCbModel_XL(testModel,'min');
