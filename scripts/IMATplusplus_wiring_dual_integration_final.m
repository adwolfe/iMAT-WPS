function [OFD, PFD, N_highFit, N_zeroFit, minLow, minTotal, minTotal_OFD, MILP, MILP_PFD, HGenes, RLNames, OpenGene, latentRxn, Nfit_latent, wasteDW] = IMATplusplus_wiring_dual_integration_final(model,epsilon_f,epsilon_r,ExpCateg, modelType, speedMode,minLowTol,doMinPFD, doLatent,latentCAP,storeProp,SideProp,ATPm,verbose) % bacCoef
