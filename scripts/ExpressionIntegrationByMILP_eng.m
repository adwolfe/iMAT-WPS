function [OpenGene, OpenedHReaction,ClosedLReaction,solution, MILPproblem] = ExpressionIntegrationByMILP_eng(model, RHNames, RLNames,HGeneList,epsilon_f, epsilon_r, logfile, runtime,verbose,forceOpenGene)
...
MILPproblem = addGeneMaximization_eng(MILPproblem, HGeneList,RHNames,RLNames, model,forceOpenGene);
