function cluster_a2_prediction_mechanism_analysis_resp(tmpDir,batchID)
%% about 
...
for zz = str2num(batchID)
    ...
    for yy = 1:2
        ...
        for ii = 1:(length(allGenes)+1)
            ...
            % loose the soft constraint (5% cap, cap is not parameterized
            % here)
